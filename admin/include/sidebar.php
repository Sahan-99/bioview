<div id="sidebar" class="sidebar">
    ...
    <div id="usersSubmenu" class="collapse <?php echo (in_array($page, ['students', 'teachers', 'admins']) ? 'show' : '') ?>">
        ...
        <a href="admin_details.php" class="submenu <?php echo ($page == 'admins' ? 'active' : '') ?>"><i class="fas fa-user-shield me-2"></i> Admins</a>
    </div>
    ...
    <div id="modelsSubmenu" class="collapse <?php echo (in_array($page, ['view_3d_models', 'add_3d_models']) ? 'show' : '') ?>">
        <a href="3d_model_details.php" class="submenu <?php echo ($page == 'view_3d_models' ? 'active' : '') ?>"><i class="fas fa-eye me-2"></i> View 3D Models</a>
    ...
    <div id="imagesSubmenu" class="collapse <?php echo (in_array($page, ['view_images', 'add_images']) ? 'show' : '') ?>">
        <a href="view_images.php" class="submenu <?php echo ($page == 'view_images' ? 'active' : '') ?>"><i class="fas fa-eye me-2"></i> View Images</a>
    ...
    <div id="audioSubmenu" class="collapse <?php echo (in_array($page, ['view_audio', 'add_audio']) ? 'show' : '') ?>">
        <a href="view_audio.php" class="submenu <?php echo ($page == 'view_audio' ? 'active' : '') ?>"><i class="fas fa-eye me-2"></i> View Audio</a>
    ...
    <div id="quizSubmenu" class="collapse <?php echo (in_array($page, ['view_quiz', 'add_quiz']) ? 'show' : '') ?>">
        <a href="view_quiz.php" class="submenu <?php echo ($page == 'view_quiz' ? 'active' : '') ?>"><i class="fas fa-eye me-2"></i> View Quiz</a>
        <a href="add_quiz.php" class="submenu <?php echo ($page == 'add_quiz' ? 'active' : '') ?>"><i class="fas fa-plus me-2"></i> Add Quiz</a>
    </div>

    <!-- Quiz Attempts Menu -->
    <a href="view_quiz_attempts.php" class="<?php echo ($page == 'view_quiz_attempts' ? 'active' : '') ?>"><i class="fas fa-history me-2"></i> Quiz Attempts</a>

    <!-- Reports Menu -->
    <a href="view_reports.php" class="<?php echo ($page == 'view_reports' ? 'active' : '') ?>"><i class="fas fa-file-alt me-2"></i> Reports</a>
</div>